...
import { getTestosteroneBoostingPlanById } from 'apiSdk/testosterone-boosting-plans';
...
function TestosteroneBoostingPlanViewPage() {
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Testosterone Boosting Plan Detail View
          </Text>
          {hasAccess('testosterone_boosting_plan', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/testosterone-boosting-plans/edit/${data?.id}`} passHref legacyBehavior>
              <Button
...
})(TestosteroneBoostingPlanViewPage);
